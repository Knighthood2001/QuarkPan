...
# 详细文件信息
python cli.py ls --details

# 搜索文件
python cli.py search "关键词"

# 创建文件夹
python cli.py files mkdir "新文件夹"

# 删除文件
python cli.py files rm file_id --force

# 获取下载链接
python cli.py files download file_id
```
...
2. **Cookie 管理**: 登录信息会自动保存到 `config/cookies.json`
3. **安全性**: 请妥善保管配置目录，避免泄露登录信息
4. **使用限制**: 请遵守夸克网盘的使用条款，合理使用 API
5. **法律责任**: 仅用于个人学习和合法用途
